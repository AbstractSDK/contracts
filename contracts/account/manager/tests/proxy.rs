...
use iabstract::{manager::ManagerModuleInfo, PROXY};
...
fn instantiate() -> AResult {
    ...
    assert_that!(account.manager.config()?).is_equal_to(iabstract::manager::ConfigResponse {
...
fn migrate_proxy() -> AResult {
    ...
    account
        .manager
        .upgrade_module(PROXY, &iabstract::proxy::MigrateMsg {})?;
