...
use abstract_sdk::{
    core::ibc_host::{HostAction, InternalAction, PacketMsg},
};
use cosmwasm_std::{
    from_slice, DepsMut, Env, IbcPacketReceiveMsg, IbcReceiveResponse, StdError,
};
...
pub fn handle_packet(
    ...
    match action {
        ...
        action => {
            ...
            HostAction::Internal(InternalAction::WhoAmI { .. }) => Err(HostError::Std(StdError::generic_err("Unreachable")))
        }
    }
    }
    .map_err(Into::into)
