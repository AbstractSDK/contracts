...
use abstract_sdk::interfaces::objects::module::ModuleVersion;
use abstract_sdk::interfaces::{api, api::BaseInstantiateMsg, manager as ManagerMsgs};
use abstract_sdk::interfaces::{objects::module::ModuleInfo, EXCHANGE};
...
pub fn register_and_create_dex_api(
    ...
    let module = ModuleInfo::from_id(
        EXCHANGE,
        abstract_sdk::interfaces::objects::module::ModuleVersion::Version(
...
fn proper_initialization() {
    ...
    let _resp: abstract_sdk::interfaces::version_control::ModuleResponse = app
        .wrap()
        .query_wasm_smart(
            env.native_contracts.version_control.clone(),
            &abstract_sdk::interfaces::version_control::QueryMsg::Module {
                module: ModuleInfo::from_id(EXCHANGE, ModuleVersion::Latest).unwrap(),
            },
        )
        .unwrap();
