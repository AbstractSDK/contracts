...
impl<'a, T: ModuleInterface> Modules<'a, T> {
    ...
    pub fn module_address(&self, module_id: ModuleId) -> SdkResult<Addr> {
    ...
    pub fn module_version(&self, module_id: ModuleId) -> SdkResult<ContractVersion> {
    ...
    fn assert_module_dependency(&self, module_id: ModuleId) -> SdkResult<()> {
...
mod test {
    ...
    fn fail_when_not_dependency_test<T: Debug>(
        modules_fn: impl FnOnce(&MockModule, Deps) -> SdkResult<T>,
