...
use cosmwasm_std::{CosmosMsg, StdResult, Uint128};
use cw_asset::Asset;
...
pub trait Chargeable {
    ...
    fn charge_fee(&mut self, fee: Fee) -> StdResult<Uint128>;
    /// Charge a fee on the asset and returns the fee transfer message.
    fn charge_usage_fee(&mut self, fee: UsageFee) -> StdResult<CosmosMsg>;
}
