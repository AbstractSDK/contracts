...
use boot_core::{IndexResponse, TxHandler, TxResponse, BootEnvironment};
use cosmwasm_std::Empty;
use secp256k1::All;
use semver::Version;
use super::DexExtension;
use super::IbcClient;
use super::OsmosisHost;
use super::Subscription;
use super::TMintStakingExtension;
use super::{
    ans_host::AnsHost,
    manager::Manager,
...
use super::{os_factory::OSFactory, version_control::VersionControl};
use abstract_os::objects::gov_type::GovernanceDetails;
use abstract_os::{
    ans_host, extension, module_factory, os_factory, version_control, ANS_HOST, ETF, EXCHANGE,
    MANAGER, MODULE_FACTORY, OS_FACTORY, PROXY, SUBSCRIPTION, TENDERMINT_STAKING, VERSION_CONTROL,
};
    ...
    TxResponse<Chain>: IndexResponse,
{
    ...
    version_control.upload_and_register_module(subscription.as_instance_mut(), &abstract_os_version)?;
