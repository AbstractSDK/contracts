...
/// This generates all the necessary code used to interact with the app in a cw-orch environement
/// Here is an example of the useful code generated by this macro
